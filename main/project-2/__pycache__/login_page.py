...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "R.", font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=100,y=300)
        label2 = Label(self.frame1, text= "legit", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=300)
